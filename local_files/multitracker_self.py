...
class JDETrackerLocal(object):
    def __init__(self, model, track_buffer=30, conf_thres=0.4, k=500, num_classes=1, down_ratio=4, reg_offset=True, frame_rate=30, ltrb=True):
        # self.opt = opt
        # if opt.gpus[0] >= 0:
